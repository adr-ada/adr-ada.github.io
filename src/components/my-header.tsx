...
const Header = () => {
    ...
    return (
        <>
            <div className="border-grid w-screen border-b px-4 md:px-60 border-neutral-700 dark:border-neutral-700 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="flex flex-1 h-14 items-center justify-between">
                    <h1 className="text-3xl font-bold whitespace-nowrap">Adriel Adasa</h1>
